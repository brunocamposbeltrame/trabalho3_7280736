...
public class Thief extends GameCharacter
{
    ...
    Thief(String s, int i)
    {
        super(s);
    }
      
    //Metodo que retorna o numero de ataque do personagem.
    protected int getAttackPts()
    {
       return 1;
    }
    
    //Metodo que retorna o numero de defesa do personagem.
    protected int getDeffensePts()
    {
      return 1;
    }
    ...
    public void addStealth(int s)
    {
        if(s > 0 && s != this.stealth)
        {
            this.stealth += s;
        }
    }
    ...
    {   
        ...
        return (int)((((0.5 * super.constitution) + (super.dexterity * 0.3) + (0.2 * super.speed)) + item_def_pts) * (super.XP / 2));
    }
    ...
    protected int getAttackPoints() 
    {
        ...
        return (int)((((0.5 * super.constitution) + (super.dexterity * 0.3) + (0.2 * super.speed)) + item_att_pts) * (super.XP / 3)) + this.stealth;
    }
}