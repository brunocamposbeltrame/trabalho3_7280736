...
public class Knight extends GameCharacter
{
    ...
    {   
        ...
        return (int)((((0.5 * super.constitution) + (super.dexterity * 0.3) + (0.2 * super.getSpeed())) + item_def_pts) * (super.XP / 2)) + this.power;
    }
    ...
    protected int getAttackPoints() 
    {
        ...
        return (int)((((0.5 * super.constitution) + (super.dexterity * 0.3) + (0.2 * super.getSpeed())) + item_att_pts) * (super.XP / 3));
    }
}